...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>𝙎𝙔𝙉𝙕𝙓 𝙎𝙆 𝘽𝘼𝙎𝙀𝘿</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="𝙋𝙐𝙏 𝙔𝙊𝙐𝙍 𝘾𝘼𝙍𝘿𝙎 𝙃𝙀𝙍𝙀"></textarea>
					<textarea rows="1" class="form-control text-center" style="width: 70%; float: left ;"  id="sec" placeholder="𝙨𝙠_𝙡𝙞𝙫𝙚_𝙨𝙮𝙣𝙯𝙭"></textarea>
    ...
    <option </option>
				...
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1CCN.php">𝘾𝘾𝙉 𝘾𝙃𝘼𝙍𝙂𝙀: $1</option>
...
<footer>
  <p> <b><div class=text-danger> CRAFTED BY <a href="https://t.me/Synzx288">SYNZX 🇮🇳</b></a></div></p>
</footer>
<style>
